...
<style>
	...
	.news-item-content-title{height: 130upx;width: 100%;font-size: 14px;font-weight: bold;color: #000000;overflow:hidden;text-overflow:ellipsis;line-height: 45upx;}
	.news-item-content-time{margin-top: 30upx;height: 30upx;display: flex;align-items: flex-end;}
</style>
